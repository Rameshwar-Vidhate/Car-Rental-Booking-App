...
const Hero = () => {
    ...
    return (
        ...
        <form className='flex flex-col md:flex-row items-center md:items-center justify-between p-6 rounded-lg md:rounded-full w-full max-w-sm md:max-w-2xl bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)]'>
