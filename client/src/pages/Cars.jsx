  ...
  return (
    <div>
      ...
      transition={{duration: 0.6, ease:'easeOut'}} className='flex flex-col items-center py-20 bg-light max-md:px-4'>
        <Title title='Available Cars' subTitle='Browser our selection of premium vehicles available for your next adventure'/>

        <motion.div initial={{opacity: 0, y: 20}} animate={{opacity: 1, y: 0}}
      transition={{delay: 0.3 , duration: 0.6}} className='flex items-center bg-white px-4 mt-6 max-w-140 w-full h-12 rounded-full shadow'>
      ...
      transition={{delay: 0.6, duration: 0.6}}  className='px-6 md:px-16 lg:px-24 xl:px-32 mt-10'>
