            ...
            <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                    <div className='flex flex-col w-full'>
                      <label>Brand</label>
                      <input type="text" placeholder="e.g. BMW, Mercedes, Audi..." required className='px-3 py2 mt-1 border border-borderColor rounded-md outline-none' value={car.brand} onChange={e=>setCar({...car, brand: e.target.value})}/>
                    </div>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
                    <div className='flex flex-col w-full'>
                      <label>Year</label>
                      <input type="number" placeholder="2025" required className='px-3 py2 mt-1 border border-borderColor rounded-md outline-none' value={car.year} onChange={e=>setCar({...car, year: e.target.value})}/>
                    </div>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
                    ...
                    <div className='flex flex-col w-full'>
                      ...
                      <input type="number" placeholder="4" required className='px-3 py2 mt-1 border border-borderColor rounded-md outline-none' value={car.seating_capacity} onChange={e=>setCar({...car, seating_capacity: e.target.value})}/>
                    </div>
                </div>
                ...
                <div className='flex flex-col w-full'>
                      ...
                      <textarea row={5}placeholder="e.g. A luxurious SUV wth a spacious interior and a powerful engine." required className='px-3 py2 mt-1 border border-borderColor rounded-md outline-none' value={car.description} onChange={e=>setCar({...car, description: e.target.value})}></textarea>
                    </div>
